...
window.STEP_CONFIG = {
  ...
  /* 現在ULとして選べるようにしておきたい人。
     ...
     この表記で書かれていない場合でも、新規登録・マイシートのUL欄で
     ここに挙げた氏名を選択肢に出す（表記ゆれを増やさないための正）。
     すでに別表記（スペース違い・旧字・ニックネームなど）でUL欄に
     入っている人がいる場合は、管理者ツールの設定タブ
     「UL・メンターの引き継ぎ」から、ここに書いた表記へまとめて
     統一しておくと揃う。 */
  KNOWN_ULS: [
    '籾山響翔','大谷紗恵','梅原菜摘','阪上耕平','新井あかね','渡邉 珠羅',
    '田中琉偉','直井理子','小林直樹','荒川陽風','佐竹 稲光'
  ]
};
