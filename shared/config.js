...
window.STEP_CONFIG = {
  ...
  /* 所属Unitの選択肢。マイシートと新規登録は、この中からだけ選ぶ。
     自由入力にしていた頃の名簿には「Unit F」「ユニットF」「Ｆ」のような
     表記ゆれが残っていて、管理者ツールは文字列の完全一致で集計するため、
  ...
  /* マイシートの「得意・のばしたい領域」で選べるタグ。
     ユニット編成のときに「このユニットにはデザインができる人がいない」を
     見つけるための軸なので、業務の種類で分けている。
     増やしたいときはここに足せば、本人画面にも管理者ツールにも出る。 */
  SKILL_TAGS: [
    '画像加工・デザイン','リール制作','ライティング','数値分析','戦略設計',
    'レポート作成','フロント対応','新人育成','AI活用','業務改善・仕組み化'
  ],
